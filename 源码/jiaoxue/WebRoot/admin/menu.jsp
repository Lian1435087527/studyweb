...
<html>
  ...
  <body target="main" bgcolor="#CCCCCC">
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <!-- 1 -->
	       <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>教师信息管理</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/teacherManage.action' target='main'>教师维护</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
	       <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items4_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/stuManage.action' target='main'>学生维护</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items3_1")'><b>留言公告新闻</b></dt>
	        <dd style='display:block' class='sitem' id='items3_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/liuyanMana.action' target='main'>留言管理</a> </li>
	            <li><a href='<%=path %>/gonggaoMana.action' target='main'>公告管理</a> </li>
	            <li><a href='<%=path %>/picNewsMana.action' target='main'>图片新闻</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
